...
public class TailItemTransformer implements TailLayoutManager.PageTransformer {
    ...
    private static final float INACTIVE_ALPHA_LEFT = 0.5f;
    ...
    private static final float INACTIVE_ALPHA_RIGHT = 0.5f;
    ...
    private static final float INACTIVE_ALPHA_CHILD = 0.5f;
    ...
    public TransformParams getParamsForPosition(float position, int childWidth, int childHeight) {
        ...
        final float half = childWidth / 2f;
