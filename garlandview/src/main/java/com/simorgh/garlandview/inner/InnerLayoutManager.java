...
public class InnerLayoutManager extends RecyclerView.LayoutManager
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (childCount == 0) {
            ...
            scrollOffset = getDecoratedBottom(Objects.requireNonNull(anchorView)) - getDecoratedMeasuredHeight(anchorView);
        }
    ...
    public int scrollVerticallyBy(int dy, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (dy < 0) { // scroll down
            ...
            final int viewHeight = getDecoratedMeasuredHeight(Objects.requireNonNull(view));
            ...
            final int viewBottom = getDecoratedBottom(Objects.requireNonNull(view));
    ...
    public int findFirstVisibleItemPosition() {
        return getChildCount() != 0 ? getPosition(Objects.requireNonNull(getChildAt(0))) : RecyclerView.NO_POSITION;
    }
    ...
    private View getTopView() {
        ...
        for (int i = 0, cnt = getChildCount(); i < cnt; i++) {
            ...
            final int bottom = getDecoratedBottom(Objects.requireNonNull(child));
            if (bottom < 0) {
                continue;
            }
