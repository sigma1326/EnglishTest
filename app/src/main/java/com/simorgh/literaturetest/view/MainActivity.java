...
import com.simorgh.literaturetest.viewModel.MainViewModel;
...
public class MainActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener
    ...
    protected void onStart() {
        super.onStart();
        try {
            if (mainViewModel != null && mainViewModel.getUserLiveData() != null && mainViewModel.getUserLiveData().getValue() != null
                    && mainViewModel.getUserLiveData().getValue().isShowTimer() && mainViewModel.getTimer() != null) {
