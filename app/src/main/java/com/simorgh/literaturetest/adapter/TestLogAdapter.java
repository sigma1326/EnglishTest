...
import com.simorgh.literaturetest.view.TestLogFragmentDirections;
...
public class TestLogAdapter extends ListAdapter<TestLog, TestLogAdapter.TestLogHolder> {
    ...
    public void onBindViewHolder(@NonNull TestLogHolder holder, final int position) {
        ...
        if (testLog != null) {
            ...
            String s1 = String.format("سوالات ادبیات کنکور گروه %s", YearMajorData.getMajorType(testLog.getMajor()));
