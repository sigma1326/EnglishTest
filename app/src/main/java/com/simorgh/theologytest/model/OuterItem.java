package com.simorgh.theologytest.model;
...
import com.simorgh.theologytest.adapter.InnerAdapter;
...
public class OuterItem extends HeaderItem {
    ...
    public void setContent(@NonNull List<YearMajorData> innerDataList) {
        headerTitle.setText(String.format("سوالات دین و زندگی کنکورهای سال %d", innerDataList.get(0).getYear()));
